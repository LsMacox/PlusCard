          ...
          <div class="block-title-create">
            <div>
              ...
              <p class="desc-15 color-text-grey">
                Добавьте ручные операции начисления по бонусным валютам
              </p>
            </div>
        ...
        >
          ...
          >
            <div>
              ...
              <p class="desc-15 color-text-grey">
                Добавьте ручные операции списания по бонусным валютам
              </p>
            </div>
            <div
              v-if="(bonusUnits.length === 0)"
  ...
  export default {
    ...
    computed: {
      ...mapGetters({
        ...
        dbBuyBonusRes: 'company/bonus_resources/manualBonusRes',
      }),
      programId () {
      ...
      buyBonusRes () {
        return this.buyBonusResInternal.map(item => {
          console.log('buyBonusResInternal.map.defore', item)
          ...
          console.log('buyBonusResInternal.map.after', item)
