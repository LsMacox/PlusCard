    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Создавайте и настраивайте программы и сертификаты,<br> отслеживайте показатели продаж и многое другое.
          </div>
        </v-row>
        <v-row
          align="center"
