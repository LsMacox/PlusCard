...
>
    <div class="modal">
        ...
        <div class="header">Список получателей</div>
        ...
        <div class="content">
            ...
            >
                ...
                <div class="type">{{getType(item.entity_type)}}</div>
...
export default {
    ...
    computed: {
        ...
        groups () {
            ...
            let groups = this.$store.getters['chat/group/groups']
    ...
    methods: {
        ...
        isSelected (entity) {
            let check = this.selectedItem.filter(item => (item.id === entity.id && item.entity_type === entity.entity_type))
