<template>
    <div id="app--conversation--list--container">
            ...
            <div style="display: flex; align-items: center;">
                <div class="app--conversation--list--search--wrapper">
                    <div class="app--conversation--list--search">
                        <input v-model="search" class="app--conversation--list--search--input" type="text"/> <span class="app--conversation--list--search--icon"><img src="/icons/search.svg" alt=""></span>
                    </div>
                </div>
                <v-btn
        ...
        <div class="app--conversation--content" v-loading="loadingConversations">
            <div
            ...
            <div
                    ...
                    style="width: 100%;"
            >
                <div class="list-empty" style="width: 100%;">Чаты не найдены</div>
            </div>
        </div>
    ...
    export default {
            ...
            conversationsFiltered() {
                ...
                if (this.conversations && this.conversations.length) {
                    ...
                    if (this.search) {
                        ...
                        let search_name = this.search.toLowerCase().trim()

                        arr = this.conversationSearcher.search(search_name)
        ...
        methods: {
            ...
            conversationChat(id) {
                ...
                // переходим на чат
                let path = `/communications/chat/${this.currentConversationType}/${id}`
                this.toRoute(path)
            },
            toRoute(path) {
            ...
            async loadConversationList() {
                ...
                // нет списка
                    ...
                    let path = '/communications/chat/business'
                    this.toRoute(path)
                }
            },
                ...
                try {
                    ...
                    if (id) {
                        ...
                        if (this.chatUser && this.chatUser.id) {
                            ...
                            // redis connect
                            this.$store.commit("auth/redis/connect")
                        }
                    }
        ...
        async mounted() {
            if (this.programId) await this.conversationInit(this.programId)
        }
    }
</script>
