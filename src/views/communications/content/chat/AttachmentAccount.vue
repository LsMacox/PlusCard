        ...
        >
            ...
            >
                ...
                <div class="account-modal-title">
                    <div v-if="account.program.use_name" class="account-modal-title-h1">{{account.program.name}}</div>
                    <div v-if="account.program.use_slogan">{{account.program.slogan}}</div>
                </div>
            </div>

            <div class="account-modal-detail">
                <div>ID: {{account.id}}</div>
                <div v-if="account.program.use_num">Номер: {{account.number}}</div>
                <div v-if="account.program.use_barcode">Штрих-код: {{account.barcode}}</div>
                <div v-if="account.program.use_pincode">Пин-код: {{account.pincode}}</div>
            </div>
            ...
            <div class="account-modal-user">
                ...
                <div class="account-modal-user-title">
                    <div class="account-modal-user-text">Владелец</div>
                    <div class="account-modal-user-name">{{account.user.name}}</div>
                </div>
            </div>
