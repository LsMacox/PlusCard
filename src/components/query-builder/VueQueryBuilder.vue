<template>
  <div
    class="query-builder form-inline"
...
<script>
  ...
  export default {
        ...
        ruleTypes: {
          ...
          numeric: {
            operators: [
              ...
              { label: '>=', value: 'GREATTHANEQUALS' },
              { label: '<=', value: 'LESSTHANEQUALS' },
              { label: '<>', value: 'NOTEQUALS' },
            ],
            inputType: 'number',
            id: 'number-field',
    ...
    methods: {
      apply () {
        console.log('THIS____QUERY')
        console.log(this.query)
        this.$emit('apply-query-value', this.query)
      },
    },
    mounted () {
      this.$watch(
