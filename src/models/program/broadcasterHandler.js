...
export default class ProgramEventBroadcasterHandler {
    static ACTION_ENUM = Object.freeze({
      ...
      BONUS_DEBIT: { id: 'BONUS_DEBIT', text: 'Списать бонусы', disabled: true },
      BONUS_CREDIT: { id: 'BONUS_CREDIT', text: 'Начислить бонусы', disabled: true },
      NOTIFICATION: { id: 'NOTIFICATION', text: 'Создать рассылку', disabled: true },
    ...
    get actionText () {
      return ProgramEventBroadcasterHandler.ACTION_ENUM.find(this.action_type).text
    }
