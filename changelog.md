...
## [2.9.8] - 2020-11-02
### Added
- Заказ сертификата. Функционал продления действия

## [2.8.8] - 2020-10-30
### Added
- Форма бонусной валюты. Добавлено поле описание
- Модель пользователя с методами проверки прав
- примесь для проверки прав
- проверка прав для всех действий с заказом серта
- Удаление серта
- Базовый выпадающий диалог - закрытие по Esc
- Разработан базовый компонент Банер
- Добавлен банер-предупреждение о модерации на форму редактирования программы

## [2.7.8] - 2020-10-29
### Fixed
- Глобальные отступы в чатах
- Настройка чатов. Порядок сохранения
- Форма создания/редактирование номиналов. Валидация полей

## [2.7.7] - 2020-10-27
### Added
- Настройка рассылки:
  - Текст СМС-приглашения
- Настройка чатов

## [2.6.7] - 2020-10-26
### Added
- Форма сертификатов:
  - Функционал отметки об использовании
- Таблица заказов сертов
  - Добавлено меню действий с сертификатом


## [2.5.7] - 2020-10-23
### Added
- Форма сертификатов:
  - Функционал оплаты сертификата


## [2.4.7] - 2020-10-22
### Added
- Переключатель круглосуточно в рабочем расписании торг точки
- - Таблица сертификатов: добавлен вывод наименования номинала
- Форма сертификатов:
  - Функционал архивирования
  - Функционал восстановления удаленных заказов
### Fixed
- Обновление магазина после сохранения
### Changed
- Стилизация ошибок для BaseTextField:
 -  'vuetify' :- базовый vuetify 
 -  'tooltip' через tooltip,
 -  'custom' - от LsMacox
